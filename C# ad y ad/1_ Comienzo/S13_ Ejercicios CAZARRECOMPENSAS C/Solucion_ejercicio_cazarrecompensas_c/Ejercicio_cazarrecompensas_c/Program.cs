...
namespace Ejercicio_cazarrecompensas_c
{
	class Program
	{
		enum Pantalla { MenuPrincipal, Batalla, Descanso, Tienda }

		static void Main()
		{
			Random generar = new Random();

			Pantalla pantallaActual = Pantalla.MenuPrincipal; // Variable para identificar la pantalla actual.
			...
			const int oroParaRetirarse = 2000;
			...
			while (enJuego)
			{
				...
				switch (pantallaActual)
				{
					...
					case Pantalla.MenuPrincipal:
						...
						Console.WriteLine("   --- EL CAZARRECOMPENSAS ---\n");
						...
						switch (opcion)
						{
							case 1:
								...
								Console.Write("Presione cualquier tecla para empezar la batalla... ");
							...
							case 2:
								do
								{
									...
									opcionLetra = char.Parse(Console.ReadLine());

								} while (opcionLetra != 'y' && opcionLetra != 'Y' && opcionLetra != 'n' && opcionLetra != 'N');

								Console.Clear();

								if (opcionLetra == 'y' || opcionLetra == 'Y')
								{
									enJuego = false;
								}
								break;
					...
					case Pantalla.Descanso:
						...
						switch (opcion)
						{
							case 1:
								...
								Console.WriteLine("\nPrepárese para la batalla...");
								Console.Write("Presione cualquier tecla para comenzar la batalla... ");
								Console.ReadKey(true);
								Console.Clear();
								pantallaActual = Pantalla.Batalla;
								break;
							...
							case 3:
								...
								if (jugadorOro >= oroParaRetirarse)
								{
									...
									// Se reinician los elementos del juego.
									pantallaActual = Pantalla.MenuPrincipal;
									jugadorVida = 100;
									jugadorArmadura = 100;
									jugadorOro = 0;
								...
								{
									Console.WriteLine("Para poder retirarse, el jugador debe tener al menos " + oroParaRetirarse + " de oro acumulado.");
								}
							...
							case 4:
								Console.WriteLine("Se ha abandonado la partida. Has perdido.\n");
								Console.Write("Presione cualquier tecla para continuar... ");
								Console.ReadKey(true);
								Console.Clear();
					...
					case Pantalla.Tienda:
						...
						Console.WriteLine("4. VOLVER AL MENU DE DESCANSO\n");
						...
						switch (opcion)
						{
							case 1:
								...
								if (jugadorOro >= precioPocion)
								{
									...
									if (jugadorVida >= 100)
									{
										Console.WriteLine("El jugador ya tiene su salud al máximo.");
									}
									else
									{
										// Se compra el ítem.
							...
							case 2:
								...
								if (jugadorOro >= precioArmadura)
								{
									...
									{
										Console.WriteLine("El jugador no necesita reparar su armadura debido a que está en perfectas condiciones.");
									}
									else
									{
