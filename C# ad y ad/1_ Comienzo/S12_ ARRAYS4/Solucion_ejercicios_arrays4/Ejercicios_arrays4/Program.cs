...
namespace Ejercicios_arrays4
{
	class Program
	{
		static void Main()
		{
			...
			// Esta sería la forma de resolverlo tratando al string como un arreglo.
			// Aún así, hay una forma mucho más sencilla de obtener al string en mayúsculas:
			// Console.Write("\nOración en mayúsculas: " + oracion.ToUpper());
