...
enum class PANTALLA { MENU_PRINCIPAL, BATALLA, DESCANSO, TIENDA };

int main()
{
	PANTALLA pantallaActual = PANTALLA::MENU_PRINCIPAL; // Variable para identificar la pantalla actual.
		...
		case PANTALLA::DESCANSO:
			...
			case 3:
				...
				if (jugadorOro >= 2000)
				{
					...
					cout << "Felicitaciones! Has ganado la partida!\n\n";
			...
			case 4:
				cout << "Se ha abandonado la partida. Has perdido.\n\n";
				system("pause");
				system("cls");
